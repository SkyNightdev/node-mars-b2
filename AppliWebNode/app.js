...
const navigationRouter = require('/includes/navigation.ejs');
app.use('/', navigationRouter);

app.get('/shop', (req, res) => {
    res.render('shop/index', {
        path: '/shop',
        user: res.locals.user  // Passer l'état de connexion de l'utilisateur au modèle EJS
    });
});
...
// Utilisez ce middleware pour chaque requête
app.use(checkAuth);


// Middleware pour stocker les informations de l'utilisateur dans res.locals
